...
namespace tl
{
        ...
        float aspectRatio)
    {
        ...
        case Compare::Tile:
            if (count > 0)
            {
                ...
                const int w = aspectRatio > 0.F ?
                    (tileSize.h * aspectRatio) :
        ...
        float aspectRatio)
    {
        ...
        return getBoxes(compare, infos, aspectRatio);
    }
        ...
        float aspectRatio)
    {
        ftk::Size2I out;
        ftk::Box2I box;
        const auto boxes = getBoxes(compare, infos, aspectRatio);
        if (!boxes.empty())
        {
            box = boxes[0];
        ...
        float aspectRatio)
    {
        ...
        return getRenderSize(compare, infos, aspectRatio);
    }
